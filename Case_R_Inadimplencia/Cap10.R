...
getwd()
#setwd("C:/Users/ssbmyn/Downloads/RStudio/3-Cap10")
...
View(dataset)
str(dataset) # resumo das variáveis
head(dataset) # visualisar as primeiras linhas
...
# Total de inadimplentes versus nao-inadimplentes no passado
...
# Nesse caso foi usado a Floresta Aleatória mas poderia ser árvore de decisão, regressão logística
...
# Falsos Negativos (Erro Tipo II): erro em que o modelo previu a classe Negativo quando o valor esperado era classe Positivo;
# Falsos Positivos (Erro Tipo I): erro em que o modelo previu a classe Positivo quando o valor esperado era classe Negativo;
